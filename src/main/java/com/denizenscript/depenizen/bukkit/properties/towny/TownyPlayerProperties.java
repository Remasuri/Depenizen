...
public class TownyPlayerProperties implements Property {
    ...
    public static final String[] handledTags = new String[] {
            "has_nation", "has_town", "mode_list", "nation_ranks", "nation", "town_ranks", "town", "towny_invites", "towny_requests"
    };
    ...
    public ObjectTag getObjectAttribute(Attribute attribute) {
        ...
        // @plugin Depenizen, Towny
        // @description
        // Returns a list of MapTags for all Towny invites this player (resident) has RECEIVED.
        // Each MapTag is generated by TownyInviteHelpers.inviteToMapTag and includes:
        // - type: "town_resident", "nation_resident", etc.
        // - sender: TownTag/NationTag/PlayerTag
        // - receiver: PlayerTag/TownTag/NationTag
        // - optional: sender_uuid, receiver_uuid, direct_sender
        // -->
        ...
        // <--[tag]
// @attribute <PlayerTag.towny_requests>
// @returns ListTag(MapTag)
// @plugin Depenizen, Towny
// @description
// Returns a list of MapTags for all Towny invites/requests this player (resident) has SENT.
// For example, join requests to towns will appear here as type "resident_town".
// Each MapTag comes from TownyInviteHelpers.inviteToMapTag.
// -->
        if (attribute.startsWith("towny_requests")) {
            Resident resident = getResident();
            if (resident == null) {
                if (!attribute.hasAlternative()) {
                    Debug.echoError("'" + player.getName() + "' is not a Towny resident!");
            ...
            for (Invite invite : InviteHandler.getActiveInvites()) {
                if (invite.getSender() instanceof Resident senderRes && senderRes.equals(resident)) {
                    out.addObject(TownyInviteHelpers.inviteToMapTag(invite));
                }
            }
            return out.getObjectAttribute(attribute.fulfill(1));
